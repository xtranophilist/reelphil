...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('movie', ['Movie_User'])


    def backwards(self, orm):
        # Deleting model 'Movie_User'
    ...
    models = {
        ...
        'movie.movie': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_data'", 'symmetrical': 'False', 'through': "orm['movie.Movie_User']", 'to': "orm['auth.User']"}),
            'year': ('django.db.models.fields.IntegerField', [], {})
        },
        'movie.movie_user': {
            'Meta': {'object_name': 'Movie_User', 'db_table': "u'movie_user'"},
