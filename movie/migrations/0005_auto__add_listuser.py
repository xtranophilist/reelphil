...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListUser'
        db.create_table(u'movie_listuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['movie.ItemList'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('on_watchlist', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('favorited', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'movie', ['ListUser'])


    def backwards(self, orm):
        # Deleting model 'ListUser'
        db.delete_table(u'movie_listuser')
    ...
    models = {
        ...
        u'movie.listuser': {
            'Meta': {'object_name': 'ListUser'},
            'favorited': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_list': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['movie.ItemList']"}),
            'on_watchlist': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'movie.movie': {
