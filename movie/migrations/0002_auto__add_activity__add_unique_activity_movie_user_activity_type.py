...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Activity', fields ['movie', 'user', 'activity_type']
        db.create_unique(u'activity', ['movie_id', 'user_id', 'activity_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Activity', fields ['movie', 'user', 'activity_type']
        db.delete_unique(u'activity', ['movie_id', 'user_id', 'activity_type'])
    ...
    models = {
        ...
        u'movie.activity': {
            'Meta': {'unique_together': "(('movie', 'user', 'activity_type'),)", 'object_name': 'Activity', 'db_table': "u'activity'"},
