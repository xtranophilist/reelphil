...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Checkin.timestamp'
        db.alter_column(u'checkin', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Checkin.timestamp'
        db.alter_column(u'checkin', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
